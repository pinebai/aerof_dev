      SUBROUTINE GENBCFLUXGAS_INT(type,gam,pstiff,enormal,evitno,
     &     U,Uinf,phi)
c-----------------------------------------------------------------------
...
c Modified 05/05/2012
c Only difference from old version is the eigensystem (based on interior)
c-----------------------------------------------------------------------
      IMPLICIT NONE
      INTEGER type, i
