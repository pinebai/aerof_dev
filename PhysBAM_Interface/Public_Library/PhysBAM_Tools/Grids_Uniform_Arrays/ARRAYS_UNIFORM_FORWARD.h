...
template<class TV> class FACE_ARRAYS_BINARY_UNIFORM;
...
template<class T,class T_NEW,int d> struct REBIND<ARRAY_BASE<T,ARRAYS_ND_BASE,VECTOR<int,d> >,T_NEW>{typedef ARRAY_BASE<T_NEW,ARRAYS_ND_BASE,VECTOR<int,d> > TYPE;};
