...
#include <PhysBAM_Tools/Matrices/MATRIX_0X1.h>
#include <PhysBAM_Tools/Matrices/MATRIX_1X1.h>
#include <PhysBAM_Tools/Matrices/MATRIX_1X2.h>
...
public:
    ...
    STATIC_ASSERT((!((m==1 && n==2) || (m>=2 && m<=3 && n>=2 && n<=3) || (m==4 && n==4) || (m==0 && (n==0 || n==1))))); // 0x0, 0x1, 1x1, 1x2, 2x2, 2x3, 3x2, 3x3, and 4x4 are specialized
