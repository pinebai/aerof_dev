#ifndef _FLUID_GNAT_SHAPE_OPTIMIZATION_HANDLER_H_
#define _FLUID_GNAT_SHAPE_OPTIMIZATION_HANDLER_H_
...
template<int dim> class ImplicitGnatTsDesc;

//------------------------------------------------------------------------------
template<int dim>
class FluidGnatShapeOptimizationHandler : public ImplicitGnatTsDesc<dim> {
...
public:
  ...
  /// \note The pointer 'dom' is passed to ImplicitGnatTsDesc
  /// and stored in the member variable domain.
  /// It seems redundant (UH - 08/10)
  FluidGnatShapeOptimizationHandler
  (
    IoData &ioData,
    GeoSource &geoSource,
    Domain *dom//,
...
#ifdef TEMPLATE_FIX
#include <FluidGnatShapeOptimizationHandler.C>
#endif
