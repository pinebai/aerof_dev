#include <FluidMetricShapeOptimizationHandler.h>
...
template<int dim>
FluidMetricShapeOptimizationHandler<dim>::FluidMetricShapeOptimizationHandler
(
  IoData &ioData,
  GeoSource &geoSource,
  Domain *dom//,
) :
ImplicitMetricTsDesc<dim>(ioData, geoSource, dom),
domain(dom),
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoRestartBcFluxs(IoData &ioData)
{
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoGetEfforts(IoData &ioData, 
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoGetDerivativeOfEffortsFiniteDifference(IoData &ioData,
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoGetDerivativeOfEffortsAnalytical(IoData &ioData,
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoGetDerivativeOfLoadFiniteDifference(IoData &ioData, DistSVec<double,3> &X, DistSVec<double,3> &dX, DistVec<double> &A,
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoGetDerivativeOfLoadAnalytical(IoData &ioData, DistSVec<double,3> &X, DistSVec<double,3> &dX, 
                                             DistSVec<double,dim> &U, DistSVec<double,dim> &dU, DistSVec<double,3> &load, DistSVec<double,3> &dLoad)
{
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoSemiAnalytical
(
  IoData &ioData, 
  DistSVec<double,3> &X,
  DistVec<double> &A,
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoAnalytical
...
//void FluidMetricShapeOptimizationHandler<dim>::computeAJ(int it, DistSVec<double, dim> &Q)  {
//
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoSetUpLinearSolver(IoData &ioData, DistSVec<double,3> &X, DistVec<double> &A, DistSVec<double,dim> &U)
{
  ...
  // Set up reduced linear system (for METRIC: Psi = dFdw*Phi)
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoPrintTextOnScreen(const char *Text)
{
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoOutput1D(const char *fileName, DistVec<double> &V)
{
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoOutput3D(const char *fileName, DistSVec<double,3> &V)
{
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoOutputDimD(const char *fileName, DistSVec<double,dim> &V)
{
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoInitialize(IoData &ioData, DistSVec<double,dim> &U)
{
...
template<int dim>
int FluidMetricShapeOptimizationHandler<dim>::fsoHandler(IoData &ioData, DistSVec<double,dim> &U)
{
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoComputeDerivativesOfFluxAndSolution(IoData &ioData, DistSVec<double,3> &X, DistVec<double> &A, DistSVec<double,dim> &U)
{
  ...
  if (ioData.sa.lsSolver == SensitivityAnalysis::NORMAL_EQUATIONS) {
    ...
    DistSVec<double, dim> weightedResRestrict(dFdS);
    if (this->rom->metric->numVectors() == 1) {
    ...
    this->projectVector(*this->AJRestrict, weightedResRestrict, this->From); 
    ...
    this->com->fprintf(stderr, "Only normal equations supported for lumped collocation sensitivity analysis\n");
    exit(-1);
  }
...
template<int dim>
void FluidMetricShapeOptimizationHandler<dim>::fsoComputeSensitivities(IoData &ioData, const char *mesage, const char *fileName, DistSVec<double,3> &X, DistSVec<double,dim> &U)
{
